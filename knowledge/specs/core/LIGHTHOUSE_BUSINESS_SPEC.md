# Lighthouse Business Specification (v1.2)
...
This is deliberately lightweight. The briefing itself is the detailed record. The account fields exist to enable pipeline views, dashboards, and assignment workflows — the kind of operational tooling that CI workflows (GitHub Actions) can automate.
