...
**Version:** 0.1
**Date:** 10 March 2026
**Status:** Draft — emerging from deliberation between Holger and the Purpose Agent
...
*This manifest was produced through deliberation between Holger Eggerichs (Founder) and the Purpose Agent on 10 March 2026. It captures architectural decisions about the agent structure of the Commons OS and supersedes the five-engine naming from earlier manifests.*

*The old names (Pattern Engine, Lighthouse Engine, Community Engine, Context Engine, Hub Engine) are honoured as the pre-architecture that led here. The new architecture: four agents, engines under D4, purpose at the centre.*
