# Lighthouse Urban Specification (v1.2) — The Coastal Edition

**Date:** 08 March 2026
**Authors:** higgerix, cloudsters, AI Thought Partner
**Status:** Draft Specification (v1.2)
**Companion:** LIGHTHOUSE_BUSINESS_SPEC.md (v1.2), PATTERN_SPEC.md (v8.2), URBAN_ENGINEERING_MANIFEST.md (v0.1), LIGHTHOUSE_ARCHETYPE_TAXONOMY.md (v1.2)
**Lineage:** cloudsters Urban Briefing Template (2024–2025, ~12 briefings), Urban Engineering Manifest (v0.1)
**Changes v1.2:** Restores orbital_layer to Group 0, renames commons_signal to commons_vitality (Group 3), consolidates 8 domain-specific dimensions into 4 universal dimensions (d1_definition_purpose, d2_participation_relationship, d3_proposition_exchange, d4_production_resilience), renames signal to vitality_signal. Same field names across all lighthouse domains. v1.1 added archetype (Group 0), replaced commons_assessment with commons_signal (Group 3), added Section 6, renumbered body sections 6-8 → 7-9.
