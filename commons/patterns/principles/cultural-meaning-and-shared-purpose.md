...
# ═══════════════════════════════════════════════════════════════════
id: pat_01kk1qnb08e7rs9n7hnpdq8dyr
orbital_layer: 1
sector: "Universal"
gravitational_hubs:
...
aliases:
  ...
  - purpose-as-structure
summary: >-
  Human systems that endure beyond a single generation are held together by shared
  meaning -- stories, symbols, rituals, and purposes that make collective action
  feel worthwhile rather than merely expedient. Without shared meaning, coordination
  becomes mechanical and fragile. Meaning is not decoration; it is load-bearing
  infrastructure. The commons engineer who neglects meaning builds systems that
  function on paper and dissolve in practice.

# ═══════════════════════════════════════════════════════════════════
# GROUP 2: CONTEXTUAL TRANSLATION (The Navigator Engine)
# ═══════════════════════════════════════════════════════════════════
context_labels:
  corporate: "Mission & Culture: The Story That Holds the Organisation Together"
  government: "Civic Identity: The Shared Narrative That Makes Collective Sacrifice Possible"
  activist: "Movement Story: The Meaning That Sustains Action Beyond Outrage"
  tech: "Team Culture: The Shared Purpose That Makes Coordination Voluntary"
...
ontology:
  ...
  commons_domain:
    - commons-engineering
  search_hints:
    primary_tension: "Instrumental Efficiency vs. Meaningful Coherence"
    vector_keywords:
      - shared-meaning
      - cultural-purpose
  ...
  commons_assessment:
    ...
    vitality: 4.9
    vitality_reasoning: >-
      Shared meaning is the invisible architecture of every durable commons. It
      determines whether people cooperate willingly or only under coercion,
      whether institutions command loyalty or merely compliance, and whether
      communities survive adversity or fragment under stress. It scores near-
      maximally because without it, every other pattern in the library loses its
      human substrate.
    overall_score: 4.71
