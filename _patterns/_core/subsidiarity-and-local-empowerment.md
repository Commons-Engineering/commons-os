...
# ═══════════════════════════════════════════════════════════════════
id: pat_01kk1qnb07ej38vqrb4s3rhyg0
orbital_layer: 1
sector: "Cross-Domain"
gravitational_hubs:
...
aliases:
  ...
  - decision-proximity
summary: >-
  Decisions should be made at the lowest level competent to make them. Every
  escalation to a higher level costs information, motivation, and speed.
  Subsidiarity is not decentralization for its own sake -- it is the engineering
  principle that the quality of a decision degrades with distance from the context
  it affects. The commons engineer distributes authority to where knowledge lives,
  and centralises only what local actors genuinely cannot resolve alone.

# ═══════════════════════════════════════════════════════════════════
# GROUP 2: CONTEXTUAL TRANSLATION (The Navigator Engine)
# ═══════════════════════════════════════════════════════════════════
context_labels:
  corporate: "Decision Rights: Push Authority to Where the Information Lives"
  government: "Subsidiarity: Govern at the Lowest Effective Level"
  activist: "Local Power: Communities Should Control What Affects Them"
  tech: "Edge Computing: Process Data Where It Originates"
...
ontology:
  ...
  commons_domain:
    - commons-engineering
  search_hints:
    primary_tension: "Central Coordination vs. Local Autonomy"
    vector_keywords:
      - subsidiarity
      - local-empowerment
      - decentralisation
  ...
  commons_assessment:
    ...
    vitality: 4.8
    vitality_reasoning: >-
      Subsidiarity is the structural prerequisite for commons that actually
      function. Without it, governance becomes remote, information-starved,
      and illegitimate. It scores maximally on autonomy and ownership because
      it is the principle that protects both from erosion by distant authority.
    overall_score: 4.86
