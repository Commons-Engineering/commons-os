...
# ═══════════════════════════════════════════════════════════════════
id: pat_01kk1nvcz0fwraj5mkcxsag7x6
orbital_layer: 1
sector: "Cross-Domain"
gravitational_hubs:
...
summary: >-
  Every system has a maximum load it can sustain. Beyond that threshold,
  the resource base degrades, feedback loops reverse, and what was growth
  becomes collapse. Carrying capacity is not a fixed number but a dynamic
  boundary shaped by technology, behaviour, and the health of the substrate.
  The commons engineer designs within limits — not because limits constrain
  ambition, but because limits make ambition survivable.

# ═══════════════════════════════════════════════════════════════════
# GROUP 2: CONTEXTUAL TRANSLATION (The Navigator Engine)
# ═══════════════════════════════════════════════════════════════════
context_labels:
  corporate: "Scalability Limits: Every Growth Curve Has a Ceiling"
  government: "Resource Ceilings: Public Services Cannot Exceed Fiscal and Natural Capacity"
  activist: "Planetary Boundaries: Earth's Systems Have Non-Negotiable Limits"
  tech: "System Load Limits: Every Architecture Has a Breaking Point"
...
ontology:
  ...
  commons_domain:
    - commons-engineering
  search_hints:
    primary_tension: "Growth Imperative vs. Carrying Capacity"
    vector_keywords:
      - carrying-capacity
      - ecological-limits
      - overshoot
  ...
  commons_assessment:
    ...
    vitality: 4.9
    vitality_reasoning: >-
      Carrying capacity is the master constraint of living systems. Every
      commons — every shared resource pool — is defined by its capacity
      limits. Understanding and respecting these limits is the difference
      between sustainable commons and tragic commons. It scores maximally
      on stakeholder architecture because overshoot harms all participants.
    overall_score: 4.86
...
relationships:
  ...
  complementary:
    ...
    - typeid: pat_01kk1nvcz3fags2sycb7cc7dee
      ...
      weight: 0.90
      source: curated
    - typeid: pat_01kk1nvcz1ee7vp273hsvdm8ks
