...
title: "The System Is the Self"
aliases:
  - self-as-first-system
  - engineer-yourself-first
summary: >-
  Before designing any external system, the Commons Engineer must design
  themselves. The practitioner is the first, most available, and most
  consequential instance of the system they seek to build. All other
  Commons Engineering work is downstream of this one.

# ═══════════════════════════════════════════════════════════════════
# GROUP 2: CONTEXTUAL TRANSLATION (The Navigator Engine)
# ═══════════════════════════════════════════════════════════════════
context_labels:
  corporate: "The Leader Is the First System to Redesign"
  government: "The Public Servant as Living Instance of Public Service"
  activist: "The Organiser as the First Commons to Tend"
  tech: "The Builder Must Build Themselves First"
...
ontology:
  ...
  commons_domain:
    - commons-engineering
  search_hints:
    primary_tension: "Designing Self vs. Designing System"
    vector_keywords:
      - self-design
      - first-system
      - practitioner
  ...
  commons_assessment:
    ...
    vitality: 5.0
    vitality_reasoning: >-
      This pattern is the source pattern Ã¢â‚¬â€� the generative root from which all
      other Commons Engineering practices derive their coherence. Its vitality
      is not a score to be measured but the condition under which all scores
      become meaningful. A system that forgets this principle loses its north.
    overall_score: 5.0
...
relationships:
  ...
  complementary:
    - typeid: pat_01mmgrnhwk9g0at8gy
      ...
      weight: 0.9
      source: migration
    - typeid: pat_01khvcxdr5f93tbwqfh4p60c5s
      slug: recognising-your-own-mental-models
      weight: 0.87
      source: migration
...
graph_garden:
  ...
  entities:
    - id: self-as-system
      type: concept
      label: "Self as Designed System"
      relevance: 1.0
    - id: inner-outer-coherence
      type: concept
      label: "InnerÃ¢â‚¬â€œOuter Coherence"
      relevance: 0.97
    - id: commons-engineer
      type: role
      label: "Commons Engineer"
      relevance: 0.95
    - id: practitioner-as-prototype
      type: concept
      label: "Practitioner as First Prototype"
      relevance: 0.95
    - id: systems-design
      type: practice
      label: "Systems Design Applied to Self"
      relevance: 0.9
    - id: lived-coherence
      type: concept
      label: "Lived Coherence"
      relevance: 0.88
    - id: recursive-design
      type: concept
      label: "Recursive / Fractal Design"
      relevance: 0.85
    - id: cognitive-age
      type: context
      label: "Cognitive Age Transition"
      relevance: 0.82
  communities:
    - id: commons-engineering-centre
      ...
      source: curated
      confidence: 1.0
    - id: personal-systems-design
      label: "Personal Systems Design & Self-Engineering"
      source: inferred
      confidence: 0.95
    - id: practitioner-development
      label: "Practitioner Development & Meta-Competence"
      source: inferred
      confidence: 0.9
  inferred_links:
    - target: coherence-as-leverage
      type: specializes_to
      confidence: 1.0
      reason: "Coherence-as-leverage is the operational form of this first principle"
    - target: engineering-attitude
      type: specializes_to
      confidence: 1.0
      reason: "Engineering attitude is the stance this principle requires"
    - target: workview-lifeview-integration
      type: enables
      confidence: 0.9
      reason: "Seeing yourself as a system makes worldview integration a design task"
    - target: recognising-your-own-mental-models
      type: complementary
      confidence: 0.87
      reason: "Mental model recognition is a core tool of self-system diagnosis"
