...
# ═══════════════════════════════════════════════════════════════════
context_labels:
  corporate: "The Leader's Dual Accountability: Personal Relevance and Institutional Responsibility"
  government: "Public Servant's Dilemma: Career Security vs. Speaking Necessary Truths"
  activist: "The Organiser's Fear: Burning Out vs. Not Doing Enough"
  tech: "Builder's Tension: Being Replaced by What You Build vs. Building Nothing"
...
ontology:
  ...
  commons_domain:
    - commons-engineering
  search_hints:
    primary_tension: "Fear as Inhibitor vs. Fear as Navigator"
    vector_keywords:
      - dual-fear
      - compass
      - personal-fear
  ...
  commons_assessment:
    ...
    vitality: 4.8
    vitality_reasoning: >-
      This pattern is most vital when the practitioner is facing a genuine
      choice between the comfortable and the necessary. It does not function
      as a steady-state practice Ã¢â‚¬â€� it functions as a navigational instrument
      at decision points. Its vitality lies in being available when most
      needed: when the practitioner is about to make a choice that will
      either reinforce or escape a pattern of strategic invisibility.
    overall_score: 4.77
...
relationships:
  ...
  specializes_to:
    ...
    - typeid: pat_cen_007
      ...
      source: migration
  enables:
    - typeid: pat_01khvcxccafhsbqcxwnskfsdr2
      slug: emotional-courage
      weight: 0.92
      source: migration
  ...
  complementary:
    ...
    - typeid: pat_cen_003
      ...
      weight: 0.82
      source: migration
    - typeid: pat_01khvcxd5sesqazwbxr1k1xzxy
      slug: uniquely-human-in-automated-world
      weight: 0.9
      source: migration
    - typeid: pat_01khvcxd7gf38rnsd89at38efb
      slug: inner-game-of-building
      weight: 0.85
      source: migration
...
graph_garden:
  ...
  entities:
    - id: personal-fear-relevance
      type: concept
      label: "Personal Fear: Cognitive Irrelevance"
      relevance: 1.0
    - id: moral-fear-complicity
      type: concept
      label: "Moral Fear: Complicity Through Silence"
      relevance: 1.0
    - id: fear-as-compass
      type: concept
      label: "Fear as Navigational Instrument"
      relevance: 0.97
    - id: cognitive-age-transition
      type: context
      label: "Cognitive Age Transition & Disruption"
      relevance: 0.93
    - id: invisible-systems-thinker
      type: role
      label: "Invisible Systems Thinker / ICP"
      relevance: 0.92
    - id: observer-mode
      type: concept
      label: "Observer Mode / Strategic Silence"
      relevance: 0.88
    - id: character-courage
      type: concept
      label: "Character & Intellectual Courage"
      relevance: 0.87
  communities:
    ...
    - id: character-development
      label: "Character, Courage & Integrity"
      source: inferred
      confidence: 0.92
    - id: cognitive-age-navigation
      label: "Cognitive Age Navigation"
      source: inferred
      confidence: 0.9
  inferred_links:
    - target: exiting-observer-mode
      type: specializes_to
      confidence: 0.95
      reason: "Dual fear names the internal navigation; observer mode exit is the action"
    - target: uniquely-human-in-automated-world
      type: complementary
      confidence: 0.9
      reason: "The personal fear is specifically addressed by understanding human distinctiveness in AI era"
    - target: emotional-courage
      type: enables
      confidence: 0.92
      reason: "Using fear as compass requires the emotional courage to act on what it indicates"
